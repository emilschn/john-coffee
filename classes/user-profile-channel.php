<?php
/**
 * Data added to the user profile channel
 */
class JohnCoffee_User_Profile_Channel {
	private $user_id;
	private $index;
	...
	public function get_meta( $meta_name ) {
		return get_user_meta( $this->user_id, $meta_name . '_' . $this->index, TRUE );
	}
	public function update_meta( $meta_name, $meta_value ) {
		update_user_meta( $this->user_id, $meta_name . '_' . $this->index, $meta_value );
	}
